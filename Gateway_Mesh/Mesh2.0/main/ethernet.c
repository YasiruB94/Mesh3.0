...
//GW required changes: import I2C functions
...
//GW required changes: build function to set/ reset the PHY pin
#ifdef GATEWAY_ETHERNET
/**
...
//GW required changes: for GW_ETH, change the method in which the PHY_POWER pin is controlled
#ifdef GATEWAY_ETHERNET
...
esp_err_t eth_init(eth_helper_init_t *eth_helper_init_struct)
{
    ...
    // GW required changes: for GW_ETH, the config parameters for ethernet are different from a normal ROOT
